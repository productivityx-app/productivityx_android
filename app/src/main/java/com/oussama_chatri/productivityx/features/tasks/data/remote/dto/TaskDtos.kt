...
data class TaskResponseDto(
    ...
    fun toEntity(fallbackUserId: String = ""): TaskEntity = TaskEntity(
        ...
        status = runCatching { TaskStatus.valueOf(status.trim().uppercase()) }.getOrNull() ?: TaskStatus.TODO,
        priority = runCatching { Priority.valueOf(priority.trim().uppercase()) }.getOrNull() ?: Priority.LOW,
